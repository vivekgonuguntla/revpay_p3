...
public class Invoice {
    ...
    public Invoice(Long id, Long userId, String invoiceNumber, String customerName, String customerEmail, String customerPhone, BigDecimal amount, String currency, LocalDate dueDate, String description, String paymentTerms, InvoiceStatus status, LocalDateTime createdAt, LocalDateTime paidAt, List<InvoiceItem> items) {
        this.id = id;
        this.userId = userId;
    ...
    public static class InvoiceBuilder {
        ...
        public Invoice build() {
            return new Invoice(id, userId, invoiceNumber, customerName, customerEmail, customerPhone, amount, currency, dueDate, description, paymentTerms, status, createdAt, paidAt, items);
        }
    }
}
