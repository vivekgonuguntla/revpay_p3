...
public class BusinessProfileController {
    ...
    public ResponseEntity<BusinessProfileResponse> getProfileByUserId(@PathVariable Long userId) {
    ...
    public ResponseEntity<BusinessProfileResponse> createOrUpdateProfile(
        ...
        return ResponseEntity.ok(businessProfileService.createOrUpdateProfile(userId, request));
    }
